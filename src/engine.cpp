    ...
    static const std::map<std::string, Enemy> enemy_db{
        ...
        { "245092", Enemy("245092",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1215850, std::chrono::milliseconds(20000),
                                           std::chrono::milliseconds(37000), "AoE", false) },
                          {}, true) },
        { "234883", Enemy("234883",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1221152, std::chrono::milliseconds(6500),
                                           std::chrono::milliseconds(18200), "AoE", false) },
                          {}, true) },
        { "242631", Enemy("242631",
                          std::vector<EnemyAbility>{ EnemyAbility(
                              1235368, std::chrono::milliseconds(6900),
                              std::chrono::milliseconds(15800), "Tank Frontal", false) },
                          {}, true) },
        { "236995", Enemy("236995",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1226111, std::chrono::milliseconds(15000),
                                           std::chrono::milliseconds(20600), "Ejection", false) },
                          {}, true) },
        { "234957", Enemy("234957",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1221483, std::chrono::milliseconds(15000),
                                           std::chrono::milliseconds(20600), "Dispel", false) },
                          {}, true) },
        { "234962", Enemy("234962",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1221679, std::chrono::milliseconds(6000),
                                           std::chrono::milliseconds(13300), "Leap", false) },
                          {}, true) },
        // Tazavesh--------------------------------------------------------------------------------
        { "180567", Enemy("180567",
                          std::vector<EnemyAbility>{
                              EnemyAbility(357827, std::chrono::milliseconds(5000),
                                           std::chrono::milliseconds(17000), "Leap", false) },
                          {}, true) },
        { "246285", Enemy("246285",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1240912, std::chrono::milliseconds(14300),
        ...
        { "178165", Enemy("178165",
                          std::vector<EnemyAbility>{
                              EnemyAbility(355429, std::chrono::milliseconds(11300),
                                           std::chrono::milliseconds(23000), "AOE", false) },
                          {}, true) },
        { "178141", Enemy("178141",
                          std::vector<EnemyAbility>{ EnemyAbility(
                              355132, std::chrono::milliseconds(9700),
                              std::chrono::milliseconds(27900), "Fish sticks", false) },
                          {}, true) },
        { "180429", Enemy("180429",
                          std::vector<EnemyAbility>{
                              EnemyAbility(357238, std::chrono::milliseconds(13600),
                                           std::chrono::milliseconds(26700), "Pulsar", false) },
                          {}, true) },
        { "179386", Enemy("179386",
                          std::vector<EnemyAbility>{
                              EnemyAbility(368661, std::chrono::milliseconds(8300),
                                           std::chrono::milliseconds(14500), "Toss", false) },
                          {}, true) },
        { "177716", Enemy("177716",
                          std::vector<EnemyAbility>{
                              EnemyAbility(351119, std::chrono::milliseconds(8000),
                                           std::chrono::milliseconds(18200), "Tee Pee", true) },
                          {}, true) },
        { "177816", Enemy("177816",
                          std::vector<EnemyAbility>{
                              EnemyAbility(355915, std::chrono::milliseconds(7300),
                                           std::chrono::milliseconds(17000), "Dispel", false) },
                          {}, true) },
        { "180431", Enemy("180431",
                          std::vector<EnemyAbility>{ EnemyAbility(
                              357260, std::chrono::milliseconds(13300),
        ...
        { "164557", Enemy("164557",
                          std::vector<EnemyAbility>{
                              EnemyAbility(326409, std::chrono::milliseconds(8900),
                                           std::chrono::milliseconds(23000), "AOE", false) },
                          {}, true) },
        { "167607", Enemy("167607",
                          std::vector<EnemyAbility>{ EnemyAbility(
                              1235326, std::chrono::milliseconds(15900),
                              std::chrono::milliseconds(32800), "Stop casting", false) },
                          {}, true) },
        { "164562", Enemy("164562",
                          std::vector<EnemyAbility>{
                              EnemyAbility(326450, std::chrono::milliseconds(15300),
                                           std::chrono::milliseconds(24200), "Loyal Beast", true) },
                          {}, true) },
        { "165414", Enemy("165414",
                          std::vector<EnemyAbility>{
                              EnemyAbility(325876, std::chrono::milliseconds(9700),
        ...
        { "230748", Enemy("230748",
                          std::vector<EnemyAbility>{
                              EnemyAbility(465827, std::chrono::milliseconds(6800),
                                           std::chrono::milliseconds(19400), "Warp blood", false) },
                          {}, true) },
        { "231014", Enemy("231014",
                          std::vector<EnemyAbility>{ EnemyAbility(
                              465120, std::chrono::milliseconds(8300),
                              std::chrono::milliseconds(17000), "Loaderbots spinning", false) },
                          {}, true) },

        // Dawnbreaker-----------------------------------------------------------------------------
        { "214761", Enemy("214761",
                          std::vector<EnemyAbility>{
                              EnemyAbility(432448, std::chrono::milliseconds(8300),
        ...
        { "210966", Enemy("210966",
                          std::vector<EnemyAbility>{
                              EnemyAbility(451107, std::chrono::milliseconds(4900),
                                           std::chrono::milliseconds(20600), "Cocoon", false) },
                          {}, true) },
        { "228540", Enemy("228540",
                          std::vector<EnemyAbility>{
                              EnemyAbility(431309, std::chrono::milliseconds(12400),
        ...
        { "211261", Enemy("211261",
                          std::vector<EnemyAbility>{
                              EnemyAbility(451102, std::chrono::milliseconds(14300),
        ...
        { "211262", Enemy("211262",
                          std::vector<EnemyAbility>{
                              EnemyAbility(451119, std::chrono::milliseconds(3900),
                                           std::chrono::milliseconds(12100), "Dot", false) },
                          {}, true) },
        { "211263", Enemy("211263",
                          std::vector<EnemyAbility>{
                              EnemyAbility(451119, std::chrono::milliseconds(4900),
                                           std::chrono::milliseconds(12100), "Dot", false),
        ...
        { "216293", Enemy("216293",
                          std::vector<EnemyAbility>{
                              EnemyAbility(434793, std::chrono::milliseconds(4000),
                                           std::chrono::milliseconds(16900), "AoE Barrage", true) },
                          {}, true) },
        { "217531", Enemy("217531",
                          std::vector<EnemyAbility>{
                              EnemyAbility(434802, std::chrono::milliseconds(9600),
                                           std::chrono::milliseconds(20800), "Fear", true) },
                          {}, true) },
        { "218324", Enemy("218324",
                          std::vector<EnemyAbility>{
                              EnemyAbility(438877, std::chrono::milliseconds(12100),
                                           std::chrono::milliseconds(21900), "AoE", false) },
                          {}, true) },
        { "216338", Enemy("216338",
                          std::vector<EnemyAbility>{
                              EnemyAbility(1241693, std::chrono::milliseconds(6000),
                                           std::chrono::milliseconds(30300), "AoE", false) },
                          {}, true) },
        { "223253", Enemy("223253",
                          std::vector<EnemyAbility>{
                              EnemyAbility(448248, std::chrono::milliseconds(4800),
                                           std::chrono::milliseconds(20600), "Volley", true) },
                          {}, true) },
        { "216364", Enemy("216364",
                          std::vector<EnemyAbility>{
                              EnemyAbility(433841, std::chrono::milliseconds(5800),
        ...
        { "206696",
          Enemy("206696",
                std::vector<EnemyAbility>{
                    EnemyAbility(427609, std::chrono::milliseconds(20400),
        ...
        { "221760", Enemy("221760",
                          std::vector<EnemyAbility>{
                              EnemyAbility(444743, std::chrono::milliseconds(9500),
                                           std::chrono::milliseconds(24300), "Volley", true) },
                          {}, true) },
        { "212826", Enemy("212826",
                          std::vector<EnemyAbility>{
                              EnemyAbility(448485, std::chrono::milliseconds(5900),
        ...
        { "212831", Enemy("212831",
                          std::vector<EnemyAbility>{
                              EnemyAbility(427897, std::chrono::milliseconds(10800),
                                           std::chrono::milliseconds(18200), "AoE", false) },
                          {}, true) },
        { "239833", Enemy("239833",
                          std::vector<EnemyAbility>{
                              EnemyAbility(424431, std::chrono::milliseconds(26100),
                                           std::chrono::milliseconds(37600), "AoE", false) },
                          {}, true) },
        { "206704", Enemy("206704",
                          std::vector<EnemyAbility>{
                              EnemyAbility(448791, std::chrono::milliseconds(15500),
                                           std::chrono::milliseconds(21700), "AoE", false) },
                          {}, true) },
        { "206699", Enemy("206699",
                          std::vector<EnemyAbility>{
                              EnemyAbility(446776, std::chrono::milliseconds(7000),
    ...
    for (auto spell : enemy.spells) {
        ...
        for (size_t i = 1; i <= iterations; ++i) {
            ...
            std::tuple<std::string, std::string, std::chrono::time_point<std::chrono::system_clock>>
                shotcall{ std::make_tuple(enemy.id, enemy.spells[i].callout,
                                          (enemy.combat_start_time + duration * i)) };
