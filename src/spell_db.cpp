...
const std::map<std::string, Enemy> enemy_db{
    ...
    { "178165", Enemy("178165",
                      std::vector<EnemyAbility>{
                          EnemyAbility(355429, ch::milliseconds(11300),
                                       ch::milliseconds(23000), "AOE", false) },
                      {}, true) },
    { "178141", Enemy("178141",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          355132, ch::milliseconds(9700),
                          ch::milliseconds(27900), "Fish sticks", false) },
                      {}, true) },
    { "180429", Enemy("180429",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          357238, ch::milliseconds(13600),
                          ch::milliseconds(26700), "Pulsar", false) },
                      {}, true) },
    { "179386", Enemy("179386",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          368661, ch::milliseconds(8300),
                          ch::milliseconds(14500), "Toss", false) },
                      {}, true) },
    { "177716", Enemy("177716",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          351119, ch::milliseconds(8000),
                          ch::milliseconds(18200), "Tee Pee", true) },
                      {}, true) },
    { "177816", Enemy("177816",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          355915, ch::milliseconds(7300),
                          ch::milliseconds(17000), "Dispel", false) },
                      {}, true) },
    { "180431", Enemy("180431",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          357260, ch::milliseconds(13300),
    ...
    { "164557", Enemy("164557",
                      std::vector<EnemyAbility>{
                          EnemyAbility(326409, ch::milliseconds(8900),
                                       ch::milliseconds(23000), "AOE", false) },
                      {}, true) },
    { "167607", Enemy("167607",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          1235326, ch::milliseconds(15900),
                          ch::milliseconds(32800), "Stop casting", false) },
                      {}, true) },
    { "164562", Enemy("164562",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          326450, ch::milliseconds(15300),
                          ch::milliseconds(24200), "Loyal Beast", true) },
                      {}, true) },
    { "165414", Enemy("165414",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          325876, ch::milliseconds(9700),
    ...
    { "214761", Enemy("214761",
                      std::vector<EnemyAbility>{
                          EnemyAbility(432448, ch::milliseconds(8300),
    ...
    { "210966", Enemy("210966",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          451107, ch::milliseconds(4900),
                          ch::milliseconds(20600), "Cocoon", false) },
                      {}, true) },
    { "228540", Enemy("228540",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          431309, ch::milliseconds(12400),
    ...
    { "211261", Enemy("211261",
                      std::vector<EnemyAbility>{
                          EnemyAbility(451102, ch::milliseconds(14300),
    ...
    { "211262", Enemy("211262",
                      std::vector<EnemyAbility>{
                          EnemyAbility(451119, ch::milliseconds(3900),
                                       ch::milliseconds(12100), "Dot", false) },
                      {}, true) },
    { "211263", Enemy("211263",
                      std::vector<EnemyAbility>{
                          EnemyAbility(451119, ch::milliseconds(4900),
                                       ch::milliseconds(12100), "Dot", false),
    ...
    { "216293", Enemy("216293",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          434793, ch::milliseconds(4000),
                          ch::milliseconds(16900), "AoE Barrage", true) },
                      {}, true) },
    { "217531", Enemy("217531",
                      std::vector<EnemyAbility>{
                          EnemyAbility(434802, ch::milliseconds(9600),
                                       ch::milliseconds(20800), "Fear", true) },
                      {}, true) },
    { "218324", Enemy("218324",
                      std::vector<EnemyAbility>{
                          EnemyAbility(438877, ch::milliseconds(12100),
                                       ch::milliseconds(21900), "AoE", false) },
                      {}, true) },
    { "216338", Enemy("216338",
                      std::vector<EnemyAbility>{
                          EnemyAbility(1241693, ch::milliseconds(6000),
                                       ch::milliseconds(30300), "AoE", false) },
                      {}, true) },
    { "223253", Enemy("223253",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          448248, ch::milliseconds(4800),
                          ch::milliseconds(20600), "Volley", true) },
                      {}, true) },
    { "216364", Enemy("216364",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          433841, ch::milliseconds(5800),
    ...
    { "206696",
      Enemy("206696",
            std::vector<EnemyAbility>{
                EnemyAbility(427609, ch::milliseconds(20400),
    ...
    { "221760", Enemy("221760",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          444743, ch::milliseconds(9500),
                          ch::milliseconds(24300), "Volley", true) },
                      {}, true) },
    { "212826",
      Enemy("212826",
            std::vector<EnemyAbility>{
                EnemyAbility(448485, ch::milliseconds(5900),
    ...
    { "212831", Enemy("212831",
                      std::vector<EnemyAbility>{
                          EnemyAbility(427897, ch::milliseconds(10800),
                                       ch::milliseconds(18200), "AoE", false) },
                      {}, true) },
    { "239833", Enemy("239833",
                      std::vector<EnemyAbility>{
                          EnemyAbility(424431, ch::milliseconds(26100),
                                       ch::milliseconds(37600), "AoE", false) },
                      {}, true) },
    { "206704", Enemy("206704",
                      std::vector<EnemyAbility>{
                          EnemyAbility(448791, ch::milliseconds(15500),
                                       ch::milliseconds(21700), "AoE", false) },
                      {}, true) },
    { "206699", Enemy("206699",
                      std::vector<EnemyAbility>{ EnemyAbility(
                          446776, ch::milliseconds(7000),
